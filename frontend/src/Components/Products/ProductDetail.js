...
const ProductDetail = () => {
  ...
  // console.log("sellerInfo", state.sellerInfo);
  // console.log("product", state.productInfo);
                  ...
                  >
                    <Button
                      sx={{
                        ...
                        height: "100%",
                        backgroundImage:
                          "url(https://siiimagesmeda.s3.eu-west-1.amazonaws.com/wp-content/uploads/2023/05/19200402/Map-A3.jpg)",
